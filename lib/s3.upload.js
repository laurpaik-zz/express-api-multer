...
// mime looks at the type of the file and tells us
// like .txt or something
const mime = require('mime');

// kinda like .split() with an extension
// gives us a lot of stuff about file paths.
const path = require('path');

// library that lets us do randomness
